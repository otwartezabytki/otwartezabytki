...
module Api
  module V1
    class RelicsController < ApiController
      ...
      def index
        p = params.slice(:query, :place, :from, :to, :categories, :state, :existence, :location, :has_photos, :has_description, :order, :latitude, :longitude, :bounding_box, :path, :radius, :per_page)
