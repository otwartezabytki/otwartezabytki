...
(function (window, document, $, undefined) {
	...
	$.extend(F, {
		...
		defaults: {
			...
			tpl: {
				...
				iframe   : '<iframe id="oz-fancybox-iframe" name="fancybox-frame{rnd}" class="fancybox-iframe" frameborder="0" vspace="0" hspace="0"' + ($.browser.msie ? ' allowtransparency="true"' : '') + '></iframe>',
		...
		showLoading: function () {
			...
			el = $('<div id="fancybox-loading" class="oz-fancybox"><div></div></div>').click(F.cancel).appendTo('body');
	...
	F.helpers.overlay = {
		...
		onReady: function (opts, obj) {
			...
			if (!this.overlay) {
				$.extend(this, {
					overlay : $('<div class="fancybox-overlay oz-fancybox"></div>').appendTo( obj.parent ),
