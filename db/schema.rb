...
ActiveRecord::Schema.define(:version => 20121205174210) do
  ...
  create_table "autocomplitions", :force => true do |t|
    ...
    t.timestamp "created_at", :limit => 6,                :null => false
    t.timestamp "updated_at", :limit => 6,                :null => false
    t.timestamp "indexed_at", :limit => 6
  ...
  create_table "original_relics", :id => false, :force => true do |t|
  ...
  add_index "original_relics", ["ancestry"], :name => "index_relics_on_ancestry"
  add_index "original_relics", ["commune_id"], :name => "index_relics_on_commune_id"
  add_index "original_relics", ["district_id"], :name => "index_relics_on_district_id"
  add_index "original_relics", ["place_id"], :name => "index_relics_on_place_id"
  add_index "original_relics", ["voivodeship_id"], :name => "index_relics_on_voivodeship_id"
